...
description: "Xây dựng tìm kiếm văn bản, match query, phrase query và các biến thể liên quan."
---

Trang này sẽ trình bày **full-text search** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
