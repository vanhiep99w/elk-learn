---
title: "Aggregations"
description: "Tổng hợp dữ liệu theo bucket, metric và pipeline aggregation để phân tích."
---

Trang này sẽ trình bày **aggregations** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
