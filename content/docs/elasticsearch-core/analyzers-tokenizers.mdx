...
description: "Tìm hiểu quá trình phân tích văn bản và cách tùy chỉnh analyzer cho ngôn ngữ."
---

Trang này sẽ trình bày **analyzers và tokenizers** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
