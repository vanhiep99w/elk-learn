...
description: "Thiết kế mapping, chọn data type và tránh các lỗi phổ biến khi tự động dynamic mapping."
---

Trang này sẽ trình bày **mapping và data types** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
