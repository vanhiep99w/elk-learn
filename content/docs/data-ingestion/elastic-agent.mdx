---
title: "Elastic Agent"
description: "Triển khai một agent hợp nhất để thu thập logs, metrics, traces và security data."
---

Trang này sẽ trình bày **elastic agent** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
