---
title: "Beats"
description: "Sử dụng Filebeat, Metricbeat và các Beats nhẹ để thu thập log và metric."
---

Trang này sẽ trình bày **beats** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
