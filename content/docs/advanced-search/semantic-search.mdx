...
description: "Tìm kiếm theo ý nghĩa bằng embedding, inference và semantic model."
---

Trang này sẽ trình bày **semantic search** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
