---
title: "Geo search"
description: "Lập chỉ mục và truy vấn dữ liệu tọa độ, khoảng cách và vùng địa lý."
---

Trang này sẽ trình bày **geo search** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
