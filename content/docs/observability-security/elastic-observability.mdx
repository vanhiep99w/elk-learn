...
description: "Tổng quan mô hình Observability và cách liên kết logs, metrics, traces trong Elastic."
---

Trang này sẽ trình bày **elastic observability** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
