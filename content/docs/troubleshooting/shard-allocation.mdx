...
description: "Điều tra shard unassigned, allocation explain và các nguyên nhân phân bổ thất bại."
---

Trang này sẽ trình bày **shard allocation** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
