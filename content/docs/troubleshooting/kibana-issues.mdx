---
title: "Kibana issues"
description: "Xử lý các lỗi kết nối, saved object, visualization và alert trong Kibana."
---

Trang này sẽ trình bày **kibana issues** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
