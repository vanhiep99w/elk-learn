...
description: "Debug pipeline, mapping error, parsing error và document bị từ chối."
---

Trang này sẽ trình bày **ingest failures** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
