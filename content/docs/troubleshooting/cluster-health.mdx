...
description: "Đọc cluster health, node stats và các tín hiệu cho thấy cluster đang gặp vấn đề."
---

Trang này sẽ trình bày **cluster health** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
