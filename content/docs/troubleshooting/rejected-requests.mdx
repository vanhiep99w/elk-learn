...
description: "Phân tích thread pool, queue và rejected request do cluster quá tải."
---

Trang này sẽ trình bày **rejected requests** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
