---
title: "ES|QL"
description: "Phân tích dữ liệu bằng pipeline query ES|QL trong Kibana và các workflow liên quan."
---

Trang này sẽ trình bày **es|ql** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
