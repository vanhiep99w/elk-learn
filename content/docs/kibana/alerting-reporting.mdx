---
title: "Alerting và reporting"
description: "Cấu hình rule, connector, alert và báo cáo định kỳ trong Kibana."
---

Trang này sẽ trình bày **alerting và reporting** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
