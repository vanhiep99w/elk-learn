...
description: "Tạo index, thêm document và kiểm tra dữ liệu bằng API cơ bản."
---

Trang này sẽ trình bày **index document đầu tiên** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
