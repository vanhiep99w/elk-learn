...
description: "Tổ chức một stack Elastic nhiều service bằng Docker Compose cho môi trường thử nghiệm."
---

Trang này sẽ trình bày **docker compose** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
