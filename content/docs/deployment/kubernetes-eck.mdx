...
description: "Triển khai và quản lý Elastic Stack trên Kubernetes bằng Elastic Cloud on Kubernetes."
---

Trang này sẽ trình bày **kubernetes và eck** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
