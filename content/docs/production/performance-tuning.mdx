...
description: "Đo lường và tối ưu indexing, search, refresh, cache cùng resource usage."
---

Trang này sẽ trình bày **performance tuning** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
