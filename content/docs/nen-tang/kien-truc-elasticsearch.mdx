...
description: "Tổng quan node, cluster, coordinator, data path và cách một request đi qua hệ thống."
---

Trang này sẽ trình bày **kiến trúc elasticsearch** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
