---
title: "OpenTelemetry"
description: "Đưa logs, metrics và traces từ OpenTelemetry vào Elastic ecosystem."
---

Trang này sẽ trình bày **opentelemetry** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
