---
title: "Java client"
description: "Sử dụng Java API Client trong ứng dụng JVM và quản lý request type-safe."
---

Trang này sẽ trình bày **java client** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
