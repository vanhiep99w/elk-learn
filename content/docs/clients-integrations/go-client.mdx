---
title: "Go client"
description: "Kết nối ứng dụng Go với Elasticsearch cho ingestion và truy vấn."
---

Trang này sẽ trình bày **go client** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
