---
title: "REST API"
description: "Sử dụng REST API để quản lý cluster, index, document và search."
---

Trang này sẽ trình bày **rest api** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
