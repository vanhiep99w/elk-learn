...
description: "Kết nối Node.js hoặc ứng dụng JavaScript với Elasticsearch bằng client chính thức."
---

Trang này sẽ trình bày **javascript client** trong bối cảnh Elasticsearch và hệ sinh thái Elastic.
